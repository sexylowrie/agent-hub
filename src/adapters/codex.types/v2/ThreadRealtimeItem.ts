...
import type { ThreadRealtimeBemItemPresentation } from "./ThreadRealtimeBemItemPresentation.ts";
import type { ThreadRealtimeSessionOutcome } from "./ThreadRealtimeSessionOutcome.ts";
import type { ThreadRealtimeTranscriptRole } from "./ThreadRealtimeTranscriptRole.ts";
/**
